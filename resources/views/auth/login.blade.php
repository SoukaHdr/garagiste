  ...
  <style>
    * {
    ...
    body {
      ...
      align-items: center;
      min-height: 100vh;
      background-color: #FFEBCD; /* Couleur de fond gris clair */
      color: white; /* Couleur de texte blanche par défaut */
    }
    .container {
      display: flex;
      background-color:   #008080; /* Couleur de fond bleu marine clair pour le cadre */
    ...
    .image-container {
      width: 50%;
      background:url("{{ asset('dist/img/Femme.jpg') }}") no-repeat left center;
