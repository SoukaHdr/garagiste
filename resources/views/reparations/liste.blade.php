...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('dist/img/tomo.jpg')}}" alt="AdminLTELogo" height="60" width="60">
  </div>

  <!-- Navbar -->
  @include('layouts.header')
  <aside class="main-sidebar sidebar-dark-primary elevation-4"  style="background-color: #DB7093;">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('dist/img/tomo.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">AUTO<span style="color: blue">REPAIR</span></span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <table class="table table-striped table-hover mt-10 w-50" >
        ...
        @foreach ($reparations as $rp)
            <tr id="row{{$rp->id}}" style="background-color: #E3F2FD;">
                <td>{{ $rp->id}}</td>
