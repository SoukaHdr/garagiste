...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('dist/img/tomo.jpg
      ')}}" alt="AdminLTELogo" height="60" width="60" style="border-radius: 6px">
  </div>
 ...
 @include('layouts.header')
  ...
  <div class="content-wrapper">
    ...
    <table class="table table-striped table-hover mt-10 w-50" >
        <tr  style="background-color:#DB7093; border-radius: 10px; color:white">
